...
for x in a:
    if(x=='svm'):
        ...
        basic_test=["Shocking and tragic. My heart goes out to the ones affected by this cowardly act at Christchurch. Thoughts with the Bangladesh team as well, stay safe. "]
        feature_basictest=[]
